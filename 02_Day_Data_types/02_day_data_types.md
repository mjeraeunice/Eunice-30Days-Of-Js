...
let accounts= 'Facebook,Google,Microsoft,Apple,IBM,Oracle,Amazon'
...
const new = /a/g;
const matching = text.match(new);
console.log(matching);
24. Use __concat()__ and merge '30 Days of' and 'JavaScript' to a single string, '30 Days Of JavaScript'
let string2='30 Days of'
let string3='JavaScript'
let oneString=string2.concat(string3)
console.log(oneString)
25. Use __repeat()__ method to print 30 Days Of JavaScript 3 times
...
if(str1.includes('on') && str2.includes('on')) {
  console.log('Both strings contain "on"');
} else {
  console.log('One or both strings do not contain "on"');
}
6. _I hope this course is not full of jargon_. Check if _jargon_ is in the sentence.
const str="I hope this course is not full of jargon."
console.log(str.includes("jargon"))
7. Generate a random number between 0 and 100 inclusively.
const randomNo = Math.floor(Math.random() * 100);
console.log(randomNo);
8. Generate a random number between 50 and 100 inclusively.
const randomNos = Math.floor(Math.random() *(100-50+1))+50;
console.log(randomNos);

9. Generate a random number between 0 and 255 inclusively.
const randomNoss = Math.floor(Math.random() *255);
console.log(randomNoss);
10. Access the 'JavaScript' string characters using a random number
let string= 'JavaSCript'
const randomIndex = Math.floor(Math.random() * string.length);
const randomCharacter = string[randomIndex];
...
const sentensi='You cannot end a sentence with because because because is a conjunction'
console.log(sentensi.slice("because because because));
### Exercises: Level 3

1. 'Love is the best thing in this world. Some found their love and some are still looking for their love.' Count the number of word __love__ in this sentence.
const words= 'Love is the best thing in this world. Some found their love and some are still looking for their love.'
console.log(words.count('love'))
2. Use __match()__ to count the number of all __because__ in the following sentence:__'You cannot end a sentence with because because because is a conjunction'__
let strii='You cannot end a sentence with because because because is a conjunction'
let striii=/because/gi
let matches=strii.match(striii)
console.log(matches)
3. Clean the following text and find the most frequent word (hint, use replace and regular expressions).
    ...
    ```
const newText = sentence.replace(/[^\w\s]/gi, '');
const frequentWord = {};
let mostFrequent = '';
let highFrequency = 0;

for (const word in frequentWord) {
  if (frequentWord[word] > highFrequency) {
    mostFrequent = word;
    highFrequency = frequentWord[word];
  }
}
...
const salaryPerMonth = parseInt(nums[0]);
const annualBonus = parseInt(nums[1]);
const onlineCoursesPerMonth = parseInt(nums[2]);
